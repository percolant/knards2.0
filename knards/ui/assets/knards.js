...
'use strict';var _aux=require('./aux'),_api=require('./api'),autosize=require('autosize'),Pikaday=require('pikaday');module.exports.initRevise=function(a){if(window.location.pathname.includes('revise')){var b,c,d=0,e=[],f=[],g=[],h=1,i='edit_date_desc',j='revise-settings';$('.revise-go-btn').on('click',function(){j='revise-run',d++,(0,_api._get_cards_list)(a,h,i,j,e,g,f,$('#datepicker-create-from').val(),$('#datepicker-create-to').val(),$('#datepicker-edit-from').val(),$('#datepicker-edit-to').val()).then(function(e){d++,b=e.card_id,c=e.revision_id,(0,_api._get_card)(a,b,e.revising).then(function(){d--,0>=d&&($('.spinner').removeClass('lc_show'),$('.done').addClass('lc_show'))}).catch(function(a){$('.spinner').removeClass('lc_show'),$('.fail').addClass('lc_show'),d=0,alert(a),window.location.replace('/revise/')}),d--,0>=d&&($('.spinner').removeClass('lc_show'),$('.done').addClass('lc_show'))}).catch(function(){$('.spinner').removeClass('lc_show'),$('.fail').addClass('lc_show'),d=0})}),$('.revise-submit-btn').on('click',function(){return'End'==$(this).text()?void 0===b?(alert(b),void window.location.replace('/revise/')):void(0,_api._save_score)(a,b,c,'last'):void((0,_api._save_score)(a,b,c),(0,_aux.deleteLoadedEntries)(),d++,(0,_api._get_cards_list)(a,h,i,j,e,g,f,$('#datepicker-create-from').val(),$('#datepicker-create-to').val(),$('#datepicker-edit-from').val(),$('#datepicker-edit-to').val()).then(function(e){d++,b=e.card_id,c=e.revision_id,(0,_api._get_card)(a,b,e.revising).then(function(){d--,0>=d&&($('.spinner').removeClass('lc_show'),$('.done').addClass('lc_show'))}).catch(function(a){$('.spinner').removeClass('lc_show'),$('.fail').addClass('lc_show'),d=0,alert(a),window.location.replace('/revise/')}),d--,0>=d&&($('.spinner').removeClass('lc_show'),$('.done').addClass('lc_show'))}).catch(function(){$('.spinner').removeClass('lc_show'),$('.fail').addClass('lc_show'),d=0}))}),$(document).on('blur','.prompt-textarea',function(){(0,_aux.checkAnswer)($(this).parent().parent())}),$(document).on('click','.show-hidden',function(){'3'==$(this).parent().parent().attr('data-entry-type')||'6'==$(this).parent().parent().attr('data-entry-type')?($(this).parent().parent().find('.prompt-textarea').css('display','none'),$(this).parent().parent().find('.entry-textarea').css('display','initial'),autosize($(this).parent().parent().find('.entry-textarea')),autosize.update($(this).parent().parent().find('.entry-textarea')),$(this).parent().parent().find('.gl_input').addClass('gl_input-red'),$(this).parent().parent().find('.gl_input').attr('data-check','0'),$(this).parent().parent().find('.entry-menu').css('display','none')):($(this).parent().parent().find('.entry-textarea').css('display','initial'),$(this).parent().parent().find('.entry-textarea').addClass('shown'),autosize($(this).parent().parent().find('.entry-textarea')),autosize.update($(this).parent().parent().find('.entry-textarea')),$(this).parent().parent().find('.entry-menu').css('display','none'))}),d++,(0,_api._get_cards_list)(a,h,i,j,e,g,f,$('#datepicker-create-from').val(),$('#datepicker-create-to').val(),$('#datepicker-edit-from').val(),$('#datepicker-edit-to').val()).then(function(){d--,0>=d&&($('.spinner').removeClass('lc_show'),$('.done').addClass('lc_show'))}).catch(function(){$('.spinner').removeClass('lc_show'),$('.fail').addClass('lc_show'),d=0}),$('#datepicker-create-from').val(''),$('#datepicker-create-to').val(''),$('#datepicker-edit-from').val(''),$('#datepicker-edit-to').val(''),new Pikaday({field:document.getElementById('datepicker-create-from')}),new Pikaday({field:document.getElementById('datepicker-create-to')}),new Pikaday({field:document.getElementById('datepicker-edit-from')}),new Pikaday({field:document.getElementById('datepicker-edit-to')}),$('#datepicker-create-from').on('change',function(){h=1,(0,_aux.deleteLoadedCards)(),d++,(0,_api._get_cards_list)(a,h,i,j,e,g,f,$('#datepicker-create-from').val(),$('#datepicker-create-to').val(),$('#datepicker-edit-from').val(),$('#datepicker-edit-to').val()).then(function(){d--,0>=d&&($('.spinner').removeClass('lc_show'),$('.done').addClass('lc_show'))}).catch(function(){$('.spinner').removeClass('lc_show'),$('.fail').addClass('lc_show'),d=0})}),$('#datepicker-create-to').on('change',function(){h=1,(0,_aux.deleteLoadedCards)(),d++,(0,_api._get_cards_list)(a,h,i,j,e,g,f,$('#datepicker-create-from').val(),$('#datepicker-create-to').val(),$('#datepicker-edit-from').val(),$('#datepicker-edit-to').val()).then(function(){d--,0>=d&&($('.spinner').removeClass('lc_show'),$('.done').addClass('lc_show'))}).catch(function(){$('.spinner').removeClass('lc_show'),$('.fail').addClass('lc_show'),d=0})}),$('#datepicker-edit-from').on('change',function(){h=1,(0,_aux.deleteLoadedCards)(),d++,(0,_api._get_cards_list)(a,h,i,j,e,g,f,$('#datepicker-create-from').val(),$('#datepicker-create-to').val(),$('#datepicker-edit-from').val(),$('#datepicker-edit-to').val()).then(function(){d--,0>=d&&($('.spinner').removeClass('lc_show'),$('.done').addClass('lc_show'))}).catch(function(){$('.spinner').removeClass('lc_show'),$('.fail').addClass('lc_show'),d=0})}),$('#datepicker-edit-to').on('change',function(){h=1,(0,_aux.deleteLoadedCards)(),d++,(0,_api._get_cards_list)(a,h,i,j,e,g,f,$('#datepicker-create-from').val(),$('#datepicker-create-to').val(),$('#datepicker-edit-from').val(),$('#datepicker-edit-to').val()).then(function(){d--,0>=d&&($('.spinner').removeClass('lc_show'),$('.done').addClass('lc_show'))}).catch(function(){$('.spinner').removeClass('lc_show'),$('.fail').addClass('lc_show'),d=0})});var k={url:a+'/api/tags/?format=json',getValue:'tag_name',list:{match:{enabled:!0},onChooseEvent:function onChooseEvent(){-1===e.indexOf($('#tags-selector').val())&&($('<span class="gl_tag-include">'+$('#tags-selector').val()+'</span>').insertBefore($('#tags-selector').closest('.easy-autocomplete')),e.push($('#tags-selector').val()),$('#tags-selector').val(''),h=1,(0,_aux.deleteLoadedCards)(),d++,(0,_api._get_cards_list)(a,h,i,j,e,g,f,$('#datepicker-create-from').val(),$('#datepicker-create-to').val(),$('#datepicker-edit-from').val(),$('#datepicker-edit-to').val()).then(function(){d--,0>=d&&($('.spinner').removeClass('lc_show'),$('.done').addClass('lc_show'))}).catch(function(){$('.spinner').removeClass('lc_show'),$('.fail').addClass('lc_show'),d=0}))}},theme:'square'};$('#tags-selector').on('keydown',function(b){13==b.keyCode&&-1===e.indexOf($('#tags-selector').val())&&($('<span class="gl_tag-include">'+$('#tags-selector').val()+'</span>').insertBefore($('#tags-selector').closest('.easy-autocomplete')),e.push($('#tags-selector').val()),setTimeout(function(){$('#tags-selector').val('')},10),h=1,(0,_aux.deleteLoadedCards)(),d++,(0,_api._get_cards_list)(a,h,i,j,e,g,f,$('#datepicker-create-from').val(),$('#datepicker-create-to').val(),$('#datepicker-edit-from').val(),$('#datepicker-edit-to').val()).then(function(){d--,0>=d&&($('.spinner').removeClass('lc_show'),$('.done').addClass('lc_show'))}).catch(function(){$('.spinner').removeClass('lc_show'),$('.fail').addClass('lc_show'),d=0})),8==b.keyCode&&''===$(this).val()&&($('#tags-selector').parent().prev().remove(),e.pop(),h=1,(0,_aux.deleteLoadedCards)(),d++,(0,_api._get_cards_list)(a,h,i,j,e,g,f,$('#datepicker-create-from').val(),$('#datepicker-create-to').val(),$('#datepicker-edit-from').val(),$('#datepicker-edit-to').val()).then(function(){d--,0>=d&&($('.spinner').removeClass('lc_show'),$('.done').addClass('lc_show'))}).catch(function(){$('.spinner').removeClass('lc_show'),$('.fail').addClass('lc_show'),d=0}))}),$(document).on('click','.gl_tag-include',function(){e.splice(e.indexOf($(this).html()),1),$(this).removeClass('gl_tag-include'),$(this).addClass('gl_tag-include-strict'),f.push($(this).text()),h=1,(0,_aux.deleteLoadedCards)(),d++,(0,_api._get_cards_list)(a,h,i,j,e,g,f,$('#datepicker-create-from').val(),$('#datepicker-create-to').val(),$('#datepicker-edit-from').val(),$('#datepicker-edit-to').val()).then(function(){d--,0>=d&&($('.spinner').removeClass('lc_show'),$('.done').addClass('lc_show'))}).catch(function(){$('.spinner').removeClass('lc_show'),$('.fail').addClass('lc_show'),d=0})}),$(document).on('click','.gl_tag-include-strict',function(){f.splice(f.indexOf($(this).html()),1),$(this).removeClass('gl_tag-include-strict'),$(this).addClass('gl_tag-exclude'),g.push($(this).text()),h=1,(0,_aux.deleteLoadedCards)(),d++,(0,_api._get_cards_list)(a,h,i,j,e,g,f,$('#datepicker-create-from').val(),$('#datepicker-create-to').val(),$('#datepicker-edit-from').val(),$('#datepicker-edit-to').val()).then(function(){d--,0>=d&&($('.spinner').removeClass('lc_show'),$('.done').addClass('lc_show'))}).catch(function(){$('.spinner').removeClass('lc_show'),$('.fail').addClass('lc_show'),d=0})}),$(document).on('click','.gl_tag-exclude',function(){g.splice(g.indexOf($(this).html()),1),$(this).remove(),h=1,(0,_aux.deleteLoadedCards)(),d++,(0,_api._get_cards_list)(a,h,i,j,e,g,f,$('#datepicker-create-from').val(),$('#datepicker-create-to').val(),$('#datepicker-edit-from').val(),$('#datepicker-edit-to').val()).then(function(){d--,0>=d&&($('.spinner').removeClass('lc_show'),$('.done').addClass('lc_show'))}).catch(function(){$('.spinner').removeClass('lc_show'),$('.fail').addClass('lc_show'),d=0})}),$('.sort-create-new-to-old').on('click',function(){$(this).hasClass('active')||($('.sort-create-new-to-old').addClass('active'),$('.sort-create-old-to-new').removeClass('active'),$('.sort-edit-new-to-old').removeClass('active'),$('.sort-edit-old-to-new').removeClass('active'),h=1,i='create_date_desc',(0,_aux.deleteLoadedCards)(),d++,(0,_api._get_cards_list)(a,h,i,j,e,g,f,$('#datepicker-create-from').val(),$('#datepicker-create-to').val(),$('#datepicker-edit-from').val(),$('#datepicker-edit-to').val()).then(function(){d--,0>=d&&($('.spinner').removeClass('lc_show'),$('.done').addClass('lc_show'))}).catch(function(){$('.spinner').removeClass('lc_show'),$('.fail').addClass('lc_show'),d=0}))}),$('.sort-create-old-to-new').on('click',function(){$(this).hasClass('active')||($('.sort-create-new-to-old').removeClass('active'),$('.sort-create-old-to-new').addClass('active'),$('.sort-edit-new-to-old').removeClass('active'),$('.sort-edit-old-to-new').removeClass('active'),h=1,i='create_date_asc',(0,_aux.deleteLoadedCards)(),d++,(0,_api._get_cards_list)(a,h,i,j,e,g,f,$('#datepicker-create-from').val(),$('#datepicker-create-to').val(),$('#datepicker-edit-from').val(),$('#datepicker-edit-to').val()).then(function(){d--,0>=d&&($('.spinner').removeClass('lc_show'),$('.done').addClass('lc_show'))}).catch(function(){$('.spinner').removeClass('lc_show'),$('.fail').addClass('lc_show'),d=0}))}),$('.sort-edit-new-to-old').on('click',function(){$(this).hasClass('active')||($('.sort-create-new-to-old').removeClass('active'),$('.sort-create-old-to-new').removeClass('active'),$('.sort-edit-new-to-old').addClass('active'),$('.sort-edit-old-to-new').removeClass('active'),h=1,i='edit_date_desc',(0,_aux.deleteLoadedCards)(),d++,(0,_api._get_cards_list)(a,h,i,j,e,g,f,$('#datepicker-create-from').val(),$('#datepicker-create-to').val(),$('#datepicker-edit-from').val(),$('#datepicker-edit-to').val()).then(function(){d--,0>=d&&($('.spinner').removeClass('lc_show'),$('.done').addClass('lc_show'))}).catch(function(){$('.spinner').removeClass('lc_show'),$('.fail').addClass('lc_show'),d=0}))}),$('.sort-edit-old-to-new').on('click',function(){$(this).hasClass('active')||($('.sort-create-new-to-old').removeClass('active'),$('.sort-create-old-to-new').removeClass('active'),$('.sort-edit-new-to-old').removeClass('active'),$('.sort-edit-old-to-new').addClass('active'),h=1,i='edit_date_asc',(0,_aux.deleteLoadedCards)(),d++,(0,_api._get_cards_list)(a,h,i,j,e,g,f,$('#datepicker-create-from').val(),$('#datepicker-create-to').val(),$('#datepicker-edit-from').val(),$('#datepicker-edit-to').val()).then(function(){d--,0>=d&&($('.spinner').removeClass('lc_show'),$('.done').addClass('lc_show'))}).catch(function(){$('.spinner').removeClass('lc_show'),$('.fail').addClass('lc_show'),d=0}))}),$('#tags-selector').easyAutocomplete(k),$(document).delegate('.entry-textarea, .prompt-textarea','keydown',function(a){var b=a.keyCode||a.which;if(9==b){a.preventDefault();var c=this.selectionStart,d=this.selectionEnd;$(this).val($(this).val().substring(0,c)+'\t'+$(this).val().substring(d)),this.selectionStart=this.selectionEnd=c+1}}),$('.card-name_input').on('keydown',function(a){var b=a.keyCode||a.which;13==b&&$(this).blur(),9==b&&$(this).blur()})}};
